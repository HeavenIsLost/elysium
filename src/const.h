...
enum MessageClasses : uint8_t {
	...
	MESSAGE_GUILD = 32, /*White message in channel (+ channelId)*/
	MESSAGE_PARTY_MANAGEMENT = 33, /*White message in channel (+ channelId)*/
	MESSAGE_PARTY = 34, /*White message in channel (+ channelId)*/
